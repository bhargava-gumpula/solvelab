...
| Storage + backup      | `lib/storage/*` (Dexie schema v5, migrations, repositories, Zod schemas, `legacy.ts` one-time localStorage imports), `lib/export/backup.ts` (format v2), `hooks/use-local-data.ts`, `hooks/use-view-preference.ts`                                                                                                                                                                                                                                      |
